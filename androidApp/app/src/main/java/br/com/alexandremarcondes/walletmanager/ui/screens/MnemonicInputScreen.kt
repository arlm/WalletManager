...
@Composable
fun MnemonicInputScreen(drawerState: DrawerState) {
    Scaffold(
        topBar = { AppBar(
        ...
        Column(
            ...
            Text(text = "Mnemonic Input Screen")
        }
    }
}
...
fun PreviewMnemonicInputScreen() {
    ApplicationTheme {
        MnemonicInputScreen(drawerState = rememberDrawerState(initialValue = DrawerValue.Closed))
    }
}